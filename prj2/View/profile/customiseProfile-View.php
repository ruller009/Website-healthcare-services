    ...
    <div class="about wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row align-items-center">
                ...
                <form method="post" action="https://localhost/prj2/Customer/customiseProfileSolution">
                    <div class="col-lg-5 col-md-6">

                        <div class="about-img">
                            <h2>Ảnh</h2>
                            <textarea id="image" name="image"><?php echo $data['infor']['img_profile']; ?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        <div class="section-header text-left">
                            <h2>Chi tiết Customer profile</h2>
                        </div>
                        <div class="about-text">
                            <h3>Họ tên:</h3>
                            <p>
                                <input type="text" name="customer-name" value="<?php echo $data['infor']['customer_name'] ?>">
                            </p>
                            <h3>Username</h3>
                            <p>
                                <input type="text" name="customer-username" value="<?php echo $data['infor']['customer_username'] ?>">
                            </p>


                            <h3>Ngày sinh:</h3>
                            <p>
                                <input type="text" name="date-of-birth" value="<?php echo $data['infor']['date_of_birth'] ?>">
                            </p>


                            <h3>Địa chỉ:</h3>
                            <p>
                                <input type="text" name="address" value="<?php echo $data['infor']['address'] ?>" size="50">
                            </p>


                            <h3>Số điện thoại:</h3>
                            <p>
                                <input type="text" name="phone" value="<?php echo $data['infor']['phone'] ?>">
                            </p>


                            <h3>Email:</h3>
                            <p>
                                <input type="text" name="email" value="<?php echo $data['infor']['email']; ?>">
                            </p>


                            <h3>Facebook:</h3>
                            <p>
                                <input type="text" name="facebook" value="<?php echo $data['infor']['facebook']; ?>">
                            </p>


                            <h3>Nghề nghiệp:</h3>
                            <p>
                                <input type="text" name="career" value="<?php echo $data['infor']['career']; ?>">
                            </p>


                            <h3>Quốc tịch:</h3>
                            <p>
                                <input type="text" name="nation" value="<?php echo $data['infor']['nationality']; ?>">
                            </p>
