        ...
        <div class="container-narrow">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="mt-3" data-aos="fade-up" data-aos-delay="200">
                <a class="btn btn-primary shadow-sm mt-1" href="">Chỉnh sửa</a>
              </div><br><br><br>
              ...
              <div class="row mt-3">
                ...
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder"><?php echo $data['infor']['staff_name']; ?></div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="pb-1">Vị trí</div>
                </div>
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder"><?php if( $data['infor']['position'] == '1' ){
                    echo "Thực tập";
                  }else if ( $data['infor']['position'] == '2' ){
                    echo "Nhân viên y tá";
                  }else if ( $data['infor']['position'] == '3' ){
                    echo "Kĩ thuật viên";
                  }else if ( $data['infor']['position'] == '4' ){
                    echo "Giáo sư";
                  }else if ( $data['infor']['position'] == '5' ){
                    echo "Giám đốc";
                  }
                  ?></div>
                </div>
            ...
            <div class="col-md-5 offset-md-1"><img class="avatar img-fluid mt-2" src="<?php echo $data['infor']['img_profile'] ?>" width="400" height="400" alt="Chưa có ảnh"/></div>
          </div>
        </div>
      </div>
