          ...
          <div class="grid pb-3" data-aos="zoom-in" data-aos-delay="100">
            ...
            if (isset($_SESSION['position'])){
              if ($_SESSION['position'] == 1){
                require('position1.php');
              }
              if ($_SESSION['position'] == 2){
                require('position2.php');
              }
              if ($_SESSION['position'] == 3){
                require('position3.php');
              }
              if ($_SESSION['position'] == 4){
                require('position4.php');
              }
              if ($_SESSION['position'] == 5){
                require('position5.php');
              }
            } 
            ?>
                          ...
                          <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
                            <div class="mt-3">
                             <div class="mt-3" data-aos="fade-up" data-aos-delay="200">
                              <button class="btn btn-primary shadow-sm mt-1"  id="btnNote-update">Chỉnh sửa</button>
                            </div><br><br><br>
                            <div class="h5"><h2>Ghi lại những ghi chú của bạn ở đây</h2></div><br>
                            <div class="note">
                              <p><?php echo $data['infor']['note']; ?></p>
                            </div>
                          </div>
                        </div>
                      </div>
