...
<div class="about-section pt-4 px-3 px-lg-4">
  <div class="container-narrow">
    <div class="row">
      ...
      <div class="col-md-5 offset-md-1"><img class="avatar img-fluid mt-2" src="<?php echo SITE_ROOT?>/Layout/profile_layout/images/avatar.jpg" width="400" height="400" alt="Walter Patterson"/></div>
    </div>
  </div>
</div>
