    ...
    <div class="blog">
        <div class="container">
            <div class="section-header text-center wow zoomIn" data-wow-delay="0.1s">
                <p>From Ruller Hospital </p>
                <h2>Danh mục</h2><br><br><br><br><br>
            </div>
            <div class="row blog-page"> 
                <?php for($no = $data["save"]["start"]; $no >= $data["save"]["end"]; $no--){
                    require("post-table-unit-View.php");
                } ?>                   
            </div>
            <div class="row">
                <div class="col-12">
                    <ul class="pagination justify-content-center">
                        <?php for($page=1;$page<=$data['save']['page-max'];$page++){
                            if($page==$data['page-index']){
                                require('page-mark.php');
                            }else{
                                require('page-normal.php');
                            }
                        } ?>
                    </ul> 
                </div>
