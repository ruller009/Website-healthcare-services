    ...
    <div class="about wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row align-items-center">
                <?php $medicine_code = $data['medicine_code']; ?>
                <form method="post" action="https://localhost/prj2/Staff/updateMedicineSolution/<?php echo $medicine_code; ?>">
                    <div class="col-lg-5 col-md-6">

                        <div class="about-img">
                            <h2>Ảnh</h2>
                            <textarea id="image" name="medicine-image"><?php echo $data['infor']['medicine_image']; ?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="about-text">
                            <h3>Tên thuốc:</h3>
                            <p>
                                <input type="" name="medicine-name" value="<?php echo $data['infor']['medicine_name'] ?>">
                            </p>
                            <h3>Mã thuốc</h3>
                            <p>
                                <input type="text" name="medicine-code" value="<?php echo $data['infor']['medicine_code'] ?>">
                            </p>
                            <h3>Nhóm thuốc:</h3>
                            <p>
                                <input type="" name="medicine-group" value="<?php echo $data['infor']['medicine_group'] ?>">
                            </p>
                            <h3>Loại thuốc:</h3>
                            <p>
                                <input type="" name="medicine-type" value="<?php echo $data['infor']['medicine_type'] ?>">
                            </p>
                            <h3>Số đăng kí:</h3>
                            <p>
                                <input type="text" name="medicine-id" value="<?php echo $data['infor']['medicine_id'] ?>">
                            </p>
                            <h3>Thành phần:</h3>
                            <p>
                                <textarea rows="10%" cols="75%" name="ingredient" ><?php echo $data['infor']['ingredient'] ?></textarea>
                            </p>
                            <h3>Công dụng:</h3>
                            <p>
                                <textarea rows="10%" cols="75%" name="impact"><?php echo $data['infor']['impact']; ?></textarea>
                            </p>
                            <h3>Cách dùng:</h3>
                            <p>
                                <textarea rows="10%" cols="75%" name="instruction"><?php echo $data['infor']['instruction']; ?></textarea>
                            </p>
