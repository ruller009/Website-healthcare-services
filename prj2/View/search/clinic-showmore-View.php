        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="about-img">
                        <img src="<?php echo $data['clinic_showmore']['clinic_image']; ?>" alt="Image">
                    </div>
                </div>
                <div class="col-lg-7 col-md-6">
                    ...
                    <div class="about-text">
                        ...
                        <p>
                            <?php echo $data['clinic_showmore']['clinic_name']; ?>
                        </p>
                        <h3>Mã phòng khám:</h3>
                        <p>
                            <?php echo $data['clinic_showmore']['clinic_code']; ?>
                        </p>
                        <h3>Địa chỉ:</h3>
                        <p>
                            <?php echo $data['clinic_showmore']['clinic_address']; ?>
                        </p>
                        <h3>Liên hệ:</h3>
                        <p>
                            <?php echo $data['clinic_showmore']['clinic_contact']; ?>
                        </p>
                        <h3>Loại phòng khám:</h3>
                        <p>
                            <?php echo $data['clinic_showmore']['clinic_type']; ?>
                        </p>
                        <h3>Nhận định về phòng khám:</h3>
                        <p>
                            <?php echo $data['clinic_showmore']['review']; ?>
                        </p>
                        <a class="btn" href="https://localhost/prj2/Search/clinic_search">Go Back</a>
                    </div>
                </div>
            </div>
        </div>
