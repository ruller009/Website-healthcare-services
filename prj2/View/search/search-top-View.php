...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <div class="row1">
                <div class="col-12">
                    <h2 align="center">Search <span><?php echo $data['name']; ?></span></h2>
                </div>
    ...
    <div class="class">
        <div class="container">
            ...
            <div class="row1">
                <div class="col-12">
                    <ul id="class-filter">
                        <li data-filter=".filter-2"><a href="https://localhost/prj2/Search/medicine_search">Medicine</a></li>
                        <li data-filter=".filter-3"><a href="https://localhost/prj2/Search/clinic_search">Clinic</a></li>
                        <li data-filter=".filter-4"><a href="https://localhost/prj2/Search/doctor_search">Doctor</a></li>
                    </ul>
                </div>
            </div>
