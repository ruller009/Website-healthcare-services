...
<head>
    <meta charset="utf-8">
    <title>Thông tin chi tiết bác sĩ</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="about-img">
                        <img src="<?php echo $data['doctor_showmore']['doctor_image']; ?>" alt="Image">
                    </div>
                </div>
                <div class="col-lg-7 col-md-6">
                    ...
                    <div class="about-text">
                        <h3>Tên bác sĩ:</h3>
                        <p>
                            <?php echo $data['doctor_showmore']['doctor_name']; ?>
                        </p>
                        <h3>Mã số bác sĩ:</h3>
                        <p>
                            <?php echo $data['doctor_showmore']['doctor_code'] ?>
                        </p>
                        <h3>Chuyên ngành:</h3>
                        <p>
                            <?php echo $data['doctor_showmore']['specialist']; ?>
                        </p>
                        <h3>Liên lạc:</h3>
                        <p>
                            <?php echo $data['doctor_showmore']['doctor_contact']; ?>
                        </p>
                        <h3>Nơi công tác:</h3>
                        <p>
                            <?php echo $data['doctor_showmore']['agency']; ?>
                        </p>
