        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="about-img">
                        <?php echo $data['medicine_showmore']['medicine_image']; ?>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6">
                    ...
                    <div class="about-text">
                        <h3>Tên thuốc:</h3>
                        <p>
                            <?php echo $data['medicine_showmore']['medicine_name']; ?>
                        </p>
                        <h3>Nhóm thuốc:</h3>
                        <p>
                            <?php echo $data['medicine_showmore']['medicine_group']; ?>
                        </p>
                        <h3>Loại thuốc:</h3>
                        <p>
                            <?php echo $data['medicine_showmore']['medicine_type']; ?>
                        </p>
                        <h3>Số đăng kí:</h3>
                        <p>
                            <?php echo $data['medicine_showmore']['medicine_id']; ?>
                        </p>
                        <h3>Thành phần:</h3>
                        <p>
                            <?php echo $data['medicine_showmore']['ingredient']; ?>
                        </p>
                        <h3>Công dụng:</h3>
                        <p>
                            <?php echo $data['medicine_showmore']['impact']; ?>
                        </p>
                        <h3>Cách dùng:</h3>
                        <p>
                            <?php echo $data['medicine_showmore']['instruction']; ?>
                        </p>
                        <a class="btn" href="https://localhost/prj2/Search/medicine_search">Go Back</a>
                    </div>
                </div>
            </div>
        </div>
