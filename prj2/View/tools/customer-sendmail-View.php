	...
	<div class="contact">
		<div class="container">
			<div class="section-header text-center wow zoomIn" data-wow-delay="0.1s">
				<p>Đưa ra câu hỏi</p>
				<h2>Chúng tôi sẽ giải đáp cho mọi câu trả lời</h2>
			</div>
			<div class="row">
				<div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
					<div class="contact-form">
						<div id="success"></div>
						<form name="sentMessage"  action="https://localhost/prj2/Customer/sendmailSolution" method="post">
							...
							<div>
								<button class="btn" type="submit" id="sendEmailButton" name="sendEmailButton">Gửi câu hỏi</button>
							</div>
						</form>
					</div>
				</div>
