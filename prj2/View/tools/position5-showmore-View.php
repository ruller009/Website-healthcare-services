            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="about-img">
                        ...
                        <img src="<?php echo $data['staff_showmore']['img_profile']; ?>">
                    </div>
                </div>
                <div class="col-lg-7 col-md-6">
                    ...
                    <div class="about-text">
                        <h3>Username của nhân viên:</h3>
                        <p>
                           <?php echo $data['staff_showmore']['staff_username']; ?>
                           
                       </p>
                       <h3>Tên nhân viên:</h3>
                       <p>
                        <?php echo $data['staff_showmore']['staff_name']; ?>
                    </p>

                    <h3>Vị trí:</h3>
                    <p>
                        <?php 
                        if( $data['staff_showmore']['position'] == '1' ){
                            echo "Thực tập";
                        }else if ( $data['staff_showmore']['position'] == '2' ){
                            echo "Nhân viên y tá";
                        }else if ( $data['staff_showmore']['position'] == '3' ){
                            echo "Kĩ thuật viên";
                        }else if ( $data['staff_showmore']['position'] == '4' ){
                            echo "Giáo sư";
                        }else if ( $data['staff_showmore']['position'] == '5' ){
                            echo "Giám đốc";
                        } ?>
                    </p>
                    ...
                    <h3>Password:</h3>
                    <p>
                        <?php echo $data['staff_showmore']['password']; ?>
                    </p>
                    <h3>Ngày sinh:</h3>
                    <p>
                        <?php echo $data['staff_showmore']['date_of_birth']; ?>
                    </p>
                    <h3>Địa chỉ:</h3>
                    <p>
                        <?php echo $data['staff_showmore']['address']; ?>
                    </p>
                    <h3>Số điện thoại:</h3>
                    <p>
                        <?php echo $data['staff_showmore']['phone']; ?>
                    </p>
                    <h3>Email:</h3>
                    <p>
                        <?php echo $data['staff_showmore']['email']; ?>
                    </p>
                    <h3>Quốc tịch:</h3>
                    <p>
                        <?php echo $data['staff_showmore']['nationality']; ?>
                    </p>

                    <h3>Ghi chú:</h3>
                    <p>
                        <?php echo $data['staff_showmore']['note']; ?>
                    </p>
                    <a class="btn" href="https://localhost/prj2/Staff/manage">Go Back</a>
                </div>
            </div>
        </div>
    </div>
