        ...
        <div class="container-table100">
            <div class="wrap-table100">
                <div class="table">
                    ...
                    require('position2-manageCustomer-unit-View.php');
                } ?>
...
<script type="text/javascript">
    $( function(){
        ...
        $('#key-search').keyup(function(){
            var customer_search = $('#key-search').val();
            $.post('https://localhost/prj2/Ajax/search_customer', {customer: customer_search}, function(data){
                $('.table').html(data); 
            });       
        })
    })
